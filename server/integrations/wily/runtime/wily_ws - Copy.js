...
exports.start = function (req,res) {
		...
		if ( !exports.running ) { exports.running = true;  console.ok("Wily Collection Started\n");  }
...
exports.stop = function (req,res) {
		...
		if ( exports.running ) { exports.running = false; console.warn("Wily Collection Stopped\n");  }
		exports.status(req,res);
...
exports.status = function (req,res) {
	...
	if ( exports.running ) res.send( { "status" : "running" } )
		else { res.send( { "status" : "stopped" } ) }
    //res.send("Is Wily collection Running ??? =  " + exports.running);
...
exports.callback = function (req,res) {
		...
		res.json({ message: 'Hooray! TrueSight Payload callback function called!' });
		
	}

exports.collect = function(req,res) {
	
	exports.getEMConfig(req,res);
	//exports.getMetricData(req,res);
	//exports.getManagedModules(req,res) ;
	//exports.getAllAlertsSnapshot(req,res); 
	
}

	
exports.getEMConfig = function(req,res) {
	...
	function wily_callback(err, client) {
		...
		client.getEMConfig(args, function(err, result) { 
			   ...
			   if ( err ) console.error( "Call Error : " + JSON.stringify(err));
                                   ...
                                   var resp = result.getEMConfigReturn; //getMetricDataReturn; //getManagedModulesReturn; //getEMConfigReturn
                                   
                                   var builder = new xml2js.Builder();
                                   //var xml = builder.buildObject(result.getEMConfigReturn)
                                   var xml = builder.buildObject(resp)
                                   console.log("Xml : " + xml); 

                                   console.info("Object keys : " + Object.keys(result)); 
                                   console.info("Raw result : " + resp);
                                   console.info("Stringified result : " + JSON.stringify(resp));
                                   
                                   var json = JSON.parse(JSON.stringify(resp));
                                   console.info("Value : " + json.$value);
                                   
					Utils.saveToFileXML('getEMConfig',xml)
					                                   
				  //TrueSight.publish(resp);			   
			   }
	...
	var url = _conf.wily_host + ":" + _conf.wily_port + _conf.wily_api_context + _conf.wily_api_events_wsdl ;
...
exports.getManagedModules = function(req,res) {
...
function wily_callback(err, client) {
		...
		client.getManagedModules(args, function(err, result) { 
			   ...
			   if ( err ) console.error( "Call Error : " + JSON.stringify(err));
                                   ...
                                   var resp = result.getManagedModulesReturn; //getMetricDataReturn; //getManagedModulesReturn; //getEMConfigReturn
					...
					Utils.saveToFileXML('getManagedModules',xml)
...
exports.getAllAlertsSnapshot = function(req,res) {
	...
	function wily_callback(err, client) {
		...
		client.getAllAlertsSnapshot(args, function(err, result) { 
			   ...
			   if ( err ) console.error( "Call Error : " + JSON.stringify(err));
                                   ...
                                   var resp = result.getAllAlertsSnapshotReturn; //getMetricDataReturn; //getManagedModulesReturn; //getEMConfigReturn
                                   ...
                                   console.info("Object keys : " + Object.keys(result)); 
                                   console.info("Raw emDashboardURL : " + resp);
                                   console.info("Stringified emDashboardURL : " + JSON.stringify(resp));
                                   
                                   var json = JSON.parse(JSON.stringify(resp));
                                   console.info("Value : " + json.$value);
                                   
					Utils.saveToFileXML('getAllAlertsSnapshot',xml)
